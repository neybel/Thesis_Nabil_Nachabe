...
function model = DYNtwocarExternal()
...
Gamma1 = -150.5;  % Adjust this parameter based on your risk preference
Gamma2 = +1.5;  % Adjust this parameter based on your risk preference

W_x = diag([1e1,1e1,1e-2,1e-2,1e-5,1e-4,1e0,1e-5,1e-5,1e-10]);
W_u=diag([1e1,1e-1,1e-3,1e0]);
W_xe= diag([1e2,1e2,1e-2,1e-2,1e-5,1e-4,1e-1,1e-5,1e-1,1e-10]);
p = SX.sym('p',10);
