...
%% Options
compile_interface = 'auto'; % true, falsecodgen_model = 'true'; % true, false
% simulation
...
qp_solver = 'partial_condensing_hpipm';qp_solver_iter_max = 100;qp_solver_cond_N = 5;qp_solver_warm_start = 0;qp_solver_cond_ric_alg = 0;qp_solver_ric_alg = 0; % HPIPM specificocp_sim_method = 'erk';ocp_sim_method_num_stages = 4;ocp_sim_method_num_steps = 4;
cost_type = 'ext_cost';
%% create model entries
model = DYNFourcarExternalCoupling();
h = 0.02;T = ocp_N*h; % horizon length time
% dims
...
x3 = model.sym_x(10:12);v3 = model.sym_x(13);
x4 = model.sym_x(15:17);v4 = model.sym_x(18);
