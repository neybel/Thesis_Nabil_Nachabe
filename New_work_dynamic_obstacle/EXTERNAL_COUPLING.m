...
quiver(start_pos_agent1(1), start_pos_agent1(2), 5, 0, 'ko', 'LineWidth', 1.5, 'MaxHeadSize', 2); % Agent 1
...
text(start_pos_agent1(1), start_pos_agent1(2) + 5, 'Agent 1 Start', 'Color', 'k', 'FontSize', 10, 'HorizontalAlignment', 'left');
...
saveas(gcf, 'ControlInputs_LaneMerging1','pdf');
