...
std_dev=[2.5; 2.5; 1e-3; 1e-3; 1e-6; 3e-3;0.25];
...
std_state = [0.1; 0.1; 0.01; 0.05; 0.02]
std_control = [0.1; 0.01]
...
range_factor = max(0.05, range_factor * 0.9985); %Reduction strategy
