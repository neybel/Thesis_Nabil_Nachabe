...
if car
W_xu1 = [1e1;1e1;1e-4;1e-4;1e-4;0.1;10];
end
...
% [particles1c,estimated_W_xuOfcar2,ess1,likelihoods1c] = customparticleFilter(X_obs2, U_obs2 ,x01, N, customnum_particles, W_xu_ranges,W_xu1,ocp,initial_guess_belief_car2,range_factor,car,std_dev,testtheta1,testtheta2,pf,D1,D2,K);
%     N = size(X_star2, 2) - 1; 
% pf=0; %it means the pf belongs to car 2
% [particles2c,estimated_W_xu_Ofcar1,ess2,likelihoods2c] = customparticleFilter(X_obs1, U_obs1 ,x01, N, customnum_particles,W_xu_ranges, W_xu1,ocp,initial_guess_belief_car1,range_factor,car,std_dev,testtheta1,testtheta2,pf,D1,D2,K);
% end
...
%     axis equal;
    ...
    for k = 2:length(x_mpc)
        ...
        pause(0.02); % Adjust the pause time to control the speed of the animation
