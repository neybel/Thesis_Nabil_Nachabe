...
initial_guess_belief_car2 = [5; 5 ;1e-2; 1e-2; 1e-5;0.01;1];
initial_guess_belief_car1 = [5 ; 5; 1e-2; 1e-2; 1e-5;0.01;1];
...
std_dev_custom=[2.5; 2.5; 1e-3; 1e-3; 1e-6; 0.25;1];
std_dev_typ = [2.5; 2.5; 1e-3; 1e-3; 1e-6; 0.25;1];
ocp_N=40;
...
if 1
    ...
    range_factor = max(0.05, range_factor * 1.0); %Reduction strategy
