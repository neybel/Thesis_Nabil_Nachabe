...
function [particles,estimated_weights,ESS,likelihoods] = customparticleFilter(X_sim,U_sim,x0, N, num_particles, W_xu_ranges, W_xu1,ocp,initial_guess,range_factor,car,std_dev,testtheta1,testtheta2,pf,D1,D2,K)
