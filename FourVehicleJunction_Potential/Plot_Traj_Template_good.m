...
time_steps = round(linspace(1, length(x_sim(1,:)), 10)); % More frequent sampling
...
text(x_sim(1,i)-5, x_sim(2,i) , num2str(i), 'Color', 'r', 'FontSize', 10, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center');
text(x_sim(6,i)-5, x_sim(7,i) , num2str(i), 'Color', 'g', 'FontSize', 10, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center');
text(x_sim(11,i), x_sim(12,i) + 2, num2str(i), 'Color', 'b', 'FontSize', 10, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center');
text(x_sim(16,i), x_sim(17,i) + 2, num2str(i), 'Color', 'm', 'FontSize', 10, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center');
end
