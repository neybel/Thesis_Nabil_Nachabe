 function waypoints = WAY3_new()
    % Define the first straight line (horizontal, moving leftwards)
    x1 = linspace(140, 115, 150); % First straight line
    y1 = linspace(-10, -10, 150); % Horizontal line
    
    % Define the arc (quarter circle, concave outwards)
    theta = linspace(3*(pi/2), pi, 150); % Angle for the arc
    radius = 15;
    centerX = 100+radius; % Center of the arc
    centerY = 5; % Adjust centerY to make the arc concave outward
