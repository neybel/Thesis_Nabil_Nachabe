...
W_x3 = [1e1,1e1,1e-4,1e-4,1e-4]; % Car from left to right
W_x4 = [1e1,1e1,1e-4,1e-4,1e-4]; % Car from right to left
W_x = diag([W_x1,W_x2,W_x3,W_x4]);
else
W_x1 = [1e1/Nx,1e1/Ny,1e-4/Ntheta,1e-4/Nv,1e-4/Ns]; %Car from down to up 
W_x2 = [1e1/Nx,1e1/Ny,1e-4/Ntheta,1e-4/Nv,1e-4/Ns]; % Car from up to down
W_x3 = [1e1/Nx,1e1/Ny,1e-4/Ntheta,1e-4/Nv,1e-4/Ns]; % Car from left to right
W_x4 = [1e1/Nx,1e1/Ny,1e-4/Ntheta,1e-4/Nv,1e-4/Ns]; % Car from right to left
W_x = diag([W_x1,W_x2,W_x3,W_x4]);
end
...
if noweight
W_u = diag([1e-4,1e-2,1e-4,1e-2,1e-4,1e-2,1e-4,1e-2]);
else
    W_u = diag([1e-4/Na,1e-2/Nss,1e-4/Na,1e-2/Nss,1e-4/Na,1e-2/Nss,1e-4/Na,1e-2/Nss]);
end
...
W_xe3=[1e-1,1e-1,1e-5,1e-4,1e-5];
W_xe4=[1e-1,1e-1,1e-5,1e-4,1e-5];
else
W_xe1=[1e-1/Nx,1e-1/Ny,1e-5/Ntheta,1e-4/Nv,1e-5/Ns];
W_xe2=[1e-1/Nx,1e-1/Ny,1e-5/Ntheta,1e-4/Nv,1e-5/Ns];
W_xe3=[1e-1/Nx,1e-1/Ny,1e-5/Ntheta,1e-4/Nv,1e-5/Ns];
W_xe4=[1e-1/Nx,1e-1/Ny,1e-5/Ntheta,1e-4/Nv,1e-5/Ns];
end
