...
function model = DYNFourcarExternalCoupling_3()
...
W_x1 = [1e1,1e-1,1e-4,1e-2,1e-4]; %Car from down to up 
...
W_u = diag([1e-4,1e-1,1e-1,1e-4,1e-5,1e-4,1e-5,1e-4]);


W_xe1=[1e-1,1e1,1e-5,1e-3,1e-5];
W_xe2=[1e-1,1e-1,1e-5,1e-3,1e-5];
W_xe3=[1e1,1e-1,1e-5,1e-3,1e-5];
W_xe4=[1e1,1e-1,1e-5,1e-3,1e-5];
