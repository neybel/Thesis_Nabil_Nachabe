...
% Merging lane (optional)
rectangle('Position', [85 -80 40 140], 'FaceColor', [0, 0, 0, 0.5],'HandleVisibility', 'off');
hold on
...
h1=plot(x_sim(1,:), x_sim(2,:), 'r*', 'LineWidth', 1);  % Agent 1
h2=plot(x_sim(6,:), x_sim(7,:), 'g*', 'LineWidth', 1);  % Agent 2
h3=plot(x_sim(11,:), x_sim(12,:), 'b*', 'LineWidth', 1); % Agent 3
h4=plot(x_sim(16,:), x_sim(17,:), 'm*', 'LineWidth', 1); % Agent 4

% Car dimensions
car_length = 3; % Length of the car representation
car_width = 3;  % Width of the car representation
...
text(x_sim(1,i), x_sim(2,i) +2.50 , num2str(i), 'Color', 'r', 'FontSize', 10, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center');
text(x_sim(6,i)-2.5, x_sim(7,i) + 2.5 , num2str(i), 'Color', 'g', 'FontSize', 10, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center');
text(x_sim(11,i)+2, x_sim(12,i) + 3.0, num2str(i), 'Color', 'b', 'FontSize', 10, 'VerticalAlignment', 'bottom', 'HorizontalAlignment', 'center');
