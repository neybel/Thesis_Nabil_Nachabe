...
%     text(numIterations * 0.9, max(distances(1, :)) * 0.9, 'D_{1,2}', 'Color', colors{1}, 'FontSize', 16, 'HorizontalAlignment', 'center');
%     text(numIterations * 0.9, max(distances(2, :)) * 0.8, 'D_{1,3}', 'Color', colors{2}, 'FontSize', 16, 'HorizontalAlignment', 'center');
%     text(numIterations * 0.9, max(distances(3, :)) * 0.7, 'D_{1,4}', 'Color', colors{3}, 'FontSize', 16, 'HorizontalAlignment', 'center');
%     text(numIterations * 0.9, max(distances(4, :)) * 0.6, 'D_{2,3}', 'Color', colors{4}, 'FontSize', 16, 'HorizontalAlignment', 'center');
%     text(numIterations * 0.9, max(distances(5, :)) * 0.5, 'D_{2,4}', 'Color', colors{5}, 'FontSize', 16, 'HorizontalAlignment', 'center');
%     text(numIterations * 0.9, max(distances(6, :)) * 0.4, 'D_{3,4}', 'Color', colors{6}, 'FontSize', 16, 'HorizontalAlignment', 'center');
