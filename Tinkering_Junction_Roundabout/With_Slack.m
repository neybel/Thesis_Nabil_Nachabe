...
% Modify constraints to include slack
% if nh > 0
%     ocp_model.set('constr_expr_h', constr.expr_h + s); % s should be defined as your slack variable
%     ocp_model.set('constr_lh', zeros(6, 1)); 
%     ocp_model.set('constr_uh', 1e8 * ones(6, 1));
% end
