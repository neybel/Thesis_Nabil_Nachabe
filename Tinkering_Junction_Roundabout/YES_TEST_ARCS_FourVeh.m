...
model = DYNFourcarExternalCoupling_3_test_withrandom();
% model = DYNFourcar_Newest();
h = 0.02;T = ocp_N*h;
% dims
...
x0 = [115; -40; pi/2;velocity0;0;90;40;1.5*pi;velocity0;0;140;-10;pi;velocity0;0;70;10;0;velocity0;0];
...
D1=WAY1_new();D2=WAY2_new();D3=WAY3_new();D4=WAY4_new();
N_sim = 500;
% N_sim = 10
