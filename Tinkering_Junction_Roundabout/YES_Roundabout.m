...
x0 = [30; 0; pi;velocity0;0;0;-60;pi/2;velocity0;0;-30;0;0;velocity0;0;0;60;1.5*pi;velocity0;0];
...
test_theta1=(pi)*ones(1, ocp_N + 1);
test_theta3=(pi/2)*ones(1, ocp_N + 1);
test_theta4=1.5*pi*ones(1, ocp_N + 1);
...
quiver(start_pos_agent3(1), start_pos_agent3(2), 0, 5, 'ko', 'LineWidth', 1.5, 'MaxHeadSize', 2); % Agent 2
quiver(start_pos_agent4(1), start_pos_agent4(2), 0, 5, 'ko', 'LineWidth', 1.5, 'MaxHeadSize', 2); % Agent 2


% Add text labels for the initial positions
text(start_pos_agent1(1)-5, start_pos_agent1(2) - 5, 'Agent 1 Start', 'Color', 'k', 'FontSize', 10, 'HorizontalAlignment', 'center');
text(start_pos_agent2(1)-5, start_pos_agent2(2) + 5, 'Agent 2 Start', 'Color', 'k', 'FontSize', 10, 'HorizontalAlignment', 'center');
text(start_pos_agent3(1)-5, start_pos_agent3(2) + 5, 'Agent 3 Start', 'Color', 'k', 'FontSize', 10, 'HorizontalAlignment', 'center');
text(start_pos_agent4(1)-5, start_pos_agent4(2) + 5, 'Agent 4 Start', 'Color', 'k', 'FontSize', 10, 'HorizontalAlignment', 'center');
...
h2=plot(x_sim(6,:),x_sim(7,:),'g*');
h3=plot(x_sim(11,:),x_sim(12,:),'b','LineWidth',2);
h4=plot(x_sim(16,:),x_sim(17,:),'k','LineWidth',2);
axis equal
...
%    ylim([-60 60])
        ...
        pause(0.0150); % Adjust the pause time to control the speed of the animation
    end
end
