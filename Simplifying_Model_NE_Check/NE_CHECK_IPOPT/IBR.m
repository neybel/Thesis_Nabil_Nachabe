...
while ~converged && iteration < max_iterations
    ...
    w01 = [u0_guess; reshape(ref1,[],1)];
%     w01 = [u0_guess; reshape(X1_prev,[],1)];

%         w01 = [u0_guess; reshape(X1_init,[],1)];
...
%     p2_val = reshape([X1_opt; ref2], [], 1); % Combine X1_opt and ref2;  I think this was wrong as in ordering
    ...
    w02 = [u0_guess; reshape(ref2,[],1)];
%       w02 = [u0_guess; reshape(X2_prev,[],1)];
%       w02 = [u0_guess; reshape(X2_init,[],1)];
