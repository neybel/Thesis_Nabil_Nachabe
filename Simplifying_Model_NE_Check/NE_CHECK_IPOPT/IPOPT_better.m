...
W_x = diag([1e3, 1e3, 1e-2, 1e-1, 1e-5, 1e3, 1e3, 1e-2, 1e-1, 1e-10]);
W_u = diag([1e-1, 1e-2, 1e-3, 1e3]);
W_xe = diag([1e5, 1e5, 1e-2, 1e-1, 1e-2, 1e2, 1e1, 1e-5, 1e-1, 1e-5]);
...
N = 400; % Number of intervals in the prediction horizon
