...
% cost
% constraints
% x0 = [110; -40; pi/2;5;0;125;-5;pi;5;0];
x0 = [125;0;pi;5;0];
...
%              y_next1 = linspace(x_sim(2,ii),x_sim(2, ii) + step_size3 , ocp_N + 1);
             y_next2 = linspace(0,0, ocp_N + 1);
           x_traj_init = [x_next2; y_next2; (pi)*ones(1, ocp_N + 1); x0(4) * ones(1, ocp_N + 1); zeros(1, ocp_N + 1)];

           p_ref=[x_traj_init;Ref]
    for jj = 0 : ocp_N - 1
        %%%%%%
