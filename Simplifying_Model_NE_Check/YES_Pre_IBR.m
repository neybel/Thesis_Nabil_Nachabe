...
N = 50; % Number of intervals in the prediction horizon
T = 0.3; % Length of each interval (sampling time)
...
x0 = [110; -20; pi/2; 2; 0; 125; 0.5; pi; 4; 0];
...
% Plot trajectories and save handles for the legend
h1 = plot(x_opt(1,:), x_opt(2,:), 'r--'); % Agent 1 trajectory
h2 = plot(x_opt(6,:), x_opt(7,:), 'b--'); % Agent 2 trajectory
