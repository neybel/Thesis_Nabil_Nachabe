...
% Scenario 1 car diagonal movement
...
W(1,1) = 100; W(2,2) = W(1,1); W(3,3) = 10; W(4,4) = 1; W(5,5)=W(4,4);
% W_e = W(nu+1:nu+nx, nu+1:nu+nx); % weight matrix in mayer term
W_e = eye(3)*1e-1;
W_e(1,1) = 1e2;
W_e(2,2)= 1e2;
...
% 	x_traj_init = [x_traj(:,2:end)];
% 	u_traj_init = [u_traj(:,2:end)];
	% get solution for sim
    % Check the robostness of this part of the code in the looping, some
