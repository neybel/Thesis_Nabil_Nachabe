...
% initial_guess = [10; 10; 1e-2; 1e-2; 1e-5;3e-2;0.50];
initial_guess = [10; 10; 1e-2; 1e-2; 1e-5;1e-2;1];


% initial_guess = [0.1; 0.1; 1e-2; 1e-2; 1e-5;1000;1000];
ESS=[];
% std_dev = [7.5; 7.5; 1e-3; 1e-3; 1e-6; 3e-3;0.25];
std_dev = [1; 1; 1e-3; 1e-3; 1e-6; 3e-10;0.25e-10];

% std_dev = [1.5e4; 1.5e4; 1e-3; 1e-3; 1e-6; 1000;1000];
ocp_N=20;
...
[traj,contr,u0,test_theta1,test_theta2] = OCP_solve(ocp,x0,W_xu1, W_xu1,car,testtheta1,testtheta2)
X_sim_next=Sim_model(sim,u0,x0)
x0=X_sim_next;
x_mpc=[x_mpc x0];u_mpc=[u_mpc u0];
% w_evol=[w_evol estimated_W_xu.W_xu'];
...
%     
    ...
    for k = 2:length(x_mpc)
        ...
        pause(0.25); % Adjust the pause time to control the speed of the animation
    end
end
