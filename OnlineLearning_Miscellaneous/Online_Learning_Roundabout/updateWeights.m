function [particles,ESS] = updateWeights(particles, X_sim, predicted_trajectories,U_sim,predicted_controls)
...
%         [likelihoods(i),total_error(i),scaling_factor(i)] = computeLikelihoodWithControl_test(X_sim, predicted_trajectories{i},U_sim,predicted_controls{i});
