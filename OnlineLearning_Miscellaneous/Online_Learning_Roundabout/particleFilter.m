...
function [particles,estimated_weights,ESS] = particleFilter(X_sim,U_sim,x0, N, num_particles, W_xu_ranges, W_xu1,ocp,initial_guess,range_factor,car,std_dev,testtheta1,testtheta2)
    % Step 1: Initialize particles
    particles = initializeParticles1(num_particles, W_xu_ranges,initial_guess,range_factor,std_dev);
    
    % Step 2: Prediction
    [predicted_trajectories,predicted_controls] = predictTrajectories(particles, x0, N, W_xu1,ocp,car,testtheta1,testtheta2);
