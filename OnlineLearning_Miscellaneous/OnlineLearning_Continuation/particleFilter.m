...
function [particles,estimated_weights] = particleFilter(X_sim,x0, N, num_particles, W_x_ranges, W_u,ocp)
    % Step 1: Initialize particles
    particles = initializeParticles1(num_particles, W_x_ranges);
