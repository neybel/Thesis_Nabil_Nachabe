function [likelihood,total_error,scaling_factor] = computeLikelihoodWithControl(X_sim, predicted_trajectory, U_star, predicted_control)
    ...
    state_weights = [10, 10, 1e-5, 1e-2, 1e-5, 1, 1, 1e-5, 1e-2, 1e-5]; % 1 1 
    control_weights = [10, 10, 10, 10]; % Example weights for control inputs % 1 1 1 1
...
dynamic_constant = 5 * max(std_error2, std_error1);
