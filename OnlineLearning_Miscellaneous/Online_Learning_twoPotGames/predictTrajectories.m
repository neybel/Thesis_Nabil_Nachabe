function [predicted_trajectories,predicted_controls] = predictTrajectories(particles, x0, N, W_xu1,ocp,car)
...
%     parfor i = 1:num_particles
    for i = 1:num_particles
        ...
        [predicted_trajectories{i},predicted_controls{i}] = OCP_solve(ocp, x0, W_xu, W_xu1,car);
