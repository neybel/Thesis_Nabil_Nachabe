...
function model = DYNtwocarExternalCoupling_variableWeights()
...
% W_x = diag([1e3,1e3,1e-2,1e-2,1e-5,1e3,1e3,1e-2,1e-2,1e-10]);
% W_u=diag([1e-3,1e-1,1e-3,1e-1]);
% W_xe= diag([1e5,1e5,1e-2,1e-2,1e-2,1e5,1e5,1e-5,1e-1,1e-5]);
p = SX.sym('p',10);
p1=SX.sym('p',14);
W_x = diag([p1(1:10)]);
W_u=diag([p1(11:14)]);
