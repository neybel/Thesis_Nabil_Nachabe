...
% W_xu_ranges = [
%     0.001, 20000;   % Range for x1
%     0.001, 20000;   % Range for y1
%     1e-5, 1;  % Range for theta1
%     1e-5, 1;  % Range for v1
%     1e-5, 1;  % Range for s1
%     1e-4  10000;
%     1e-2  10000;  
...
initial_guess = [1250; 1250; 1e-2; 1e-2; 1e-5;0.010;0.30];

% initial_guess = [0.1; 0.1; 1e-2; 1e-2; 1e-5;1000;1000];
ESS=[];
std_dev = [500; 500; 1e-3; 1e-3; 1e-6; 1e-1;0.10];
...
range_factor = max(0.05, range_factor * 0.99); %Reduction strategy
