...
Gamma1 = -4.0;  % Adjust this parameter based on your risk preference
Gamma2 = +0.5;  % Adjust this parameter based on your risk preference
Gamma = [Gamma1, Gamma2];
num_samples = 30;  % Number of Monte Carlo samples


W_x = diag([1e0,1e-1,1e-2,1e-2,1e-5,1e0,1e-1,1e-2,1e-2,1e-5]);
W_u=diag([1e-3,1e-1,1e-3,1e-1]);
W_xe= diag([1e-1,1e-1,1e-5,1e-3,1e-5,1e-1,1e-1,1e-5,1e-3,1e-5]);
p = SX.sym('p',10);
