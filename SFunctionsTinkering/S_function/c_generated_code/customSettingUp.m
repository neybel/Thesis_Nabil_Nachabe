...
nlp_solver_max_iter = 500; %sqp max iteration probably 500 (50 before)
qp_solver = 'partial_condensing_hpipm';
% full_condensing_hpipm, partial_condensing_hpipm, full_condensing_qpoases
qp_solver_iter_max = 100;
qp_solver_cond_N = 5;
qp_solver_warm_start = 0; % take result from previous (1)
...
% constraints
% velocity0 = 0; 
% x0 = [0;-60;pi/2;velocity0;0;-30;0;0;velocity0;0];% Jbx = zeros(1, nx); for ii=1:nbx Jbx(ii,ii)=1.0; end
% lbx = 0*ones(nbx, 1);
% ubx =  120*ones(nbx, 1);
...
sim = acados_sim(sim_model,sim_opts);
 ...
 disp('Custom setting up is finished.');
    
%     % Stop the Simulink simulation after setup is complete
