function [particles,ESS,likelihoods] = customupdateWeights(particles, X_sim, predicted_trajectories,U_sim,predicted_controls)
...
%         [likelihoods(i),total_error(i),scaling_factor(i)] = computeLikelihoodWithControl(X_sim, predicted_trajectories{i},U_sim,predicted_controls{i});
                [likelihoods(i),total_error(i),scaling_factor(i)] = customcomputeLikelihoodWithControl_noisy(X_sim, predicted_trajectories{i},U_sim,predicted_controls{i});
